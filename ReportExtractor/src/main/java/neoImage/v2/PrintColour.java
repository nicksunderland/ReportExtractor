 ...
 *
 * This class helps print colours to the console
 *
 */
public class PrintColour {
    ...
    //Print
    public static void print(String message, String colour) {
    	System.out.print(colour + message + RESET);
    }
    ...
    public static void whiteUnderlined(String message) {
        System.out.println(WHITE_UNDERLINED + message + RESET);
    }
